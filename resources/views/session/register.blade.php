            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        ...
                        <p class="text-lead text-white">Ingresa tus datos en el formulario y te contáctaremos lo antes
                            posible.</p>
                    </div>
                </div>
            </div>
                            ...
                            <form role="form text-left" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-check form-check-info text-left">
                                    ...
                                    <label class="form-check-label" for="flexCheckDefault">
                                        Acepto los <a href="#" class="text-dark font-weight-bolder">Términos y
                                            Condiciones</a>
                                    </label>
                                    @error('agreement')
                                ...
                                <p class="text-sm mt-3 mb-0">¿Ya tienes una cuenta? Ingresa al
                                    <a href="{{ route('login') }}" class="text-dark font-weight-bolder">Campus Virtual</a>
                                </p>
                            </form>
                        </div>
                    </div>
