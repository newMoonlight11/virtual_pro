      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Ingresa tus datos en el formulario y te contáctaremos lo antes posible.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <div class="mb-3">
                  <input type="email" class="form-control" placeholder="Teléfono" name="phone" id="phone" aria-label="Phone" aria-describedby="phone" value="{{ old('phone') }}">
                  @error('phone')
                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                  @enderror
                </div>
                ...
                <p class="text-sm mt-3 mb-0">¿Ya tienes una cuenta? Ingresa al <a href="login" class="text-dark font-weight-bolder">Campus Virtual</a></p>
              </form>
            </div>
          </div>
        </div>
