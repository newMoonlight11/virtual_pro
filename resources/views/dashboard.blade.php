                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="d-flex flex-column h-100">
                                @if ($anuncio)
                                    <p class="mb-1 pt-2 text-bold">Último Anuncio</p>
                                    <h5 class="font-weight-bolder">{{ $anuncio->titulo }}</h5>
                                    <p class="mb-5">{{ $anuncio->subtitulo }}</p>
                                ...
                                @else
                                    <p class="mb-1 pt-2 text-bold">Último Anuncio</p>
                                    <h5 class="font-weight-bolder">No hay anuncios aún</h5>
                                    <p class="mb-5">Cuando se publiquen anuncios, aparecerán aquí.</p>
                                @endif
                            </div>
                        </div>
            ...
            <div class="card h-100 p-3">
                <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100"
                    ...
                    <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                        ...
                        <p class="text-white">Revisa el contenido que se acaba de subir, te presentamos tips para la
                            presentación de tu exámen.</p>
