    ...
    <div class="container">
      <div class="row">
        <div class="d-flex justify-content-center align-items-center flex-wrap mb-3">
          <a href="https://wa.me/qr/ZM27K3GRHSH7I1" target="_blank" class="text-secondary me-4">
            <i class="bi bi-whatsapp text-secondary fs-5"></i>
          </a>
          <a href="https://www.instagram.com/preicfesvirtualpro?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" class="text-secondary me-4">
            <i class="bi bi-instagram text-secondary fs-5"></i>
          </a>
          <a href="https://www.facebook.com/profile.php?id=61572300945137" target="_blank" class="text-secondary me-4">
